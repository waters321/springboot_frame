          ...
          <div class="layui-row">
            ...
            <div class="layui-col-xs5">
              <div style="margin-left: 10px;">
                <img src="${ctx}/user/generalVerify" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode">
              </div>
            </div>
          </div>
        </div>
      ...
      admin.req({
        ...
        ,done: function(res){
          ...
          layer.msg('登入成功', {
            ...
            location.href = '${ctx}/user/index'; //后台主页
          });
        }
      });
    ...
    layer.msg('为了方便演示，用户名密码可随意输入', {
      ...
      ,icon: 1
  		...
  		$body.on('click', '#LAY-user-get-vercode', function() {
  			var othis = $(this);
  			this.src = '${ctx}/user/generalVerify?t=' + new Date().getTime()
  		});
